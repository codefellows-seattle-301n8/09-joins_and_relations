...
app.post('/articles', function(request, response) {
  ...
  function queryThree(author_id) {
    client.query(
      `INSERT INTO articles(article_id, author_id, title, category,"publishedOn", body) VALUES ($1, $2, $3, $4, $5, $6) ON CONFLICT DO NOTHING`, // TODO: Write a SQL query to insert the new article using the author_id from our previous query
      [request.body.article_id, author_id, request.body.title, request.body.category, request.body.publishedOn, request.body.body], // TODO: Add the data from our new article, including the author_id, as data for the SQL query.
      function(err) {
        if (err) console.error(err);
...
app.put('/articles/:id', function(request, response) {
  ...
  .then(function() {
    ...
    client.query(
      `UPDATE article
      SET article_id=$1, title=$3, category=$4, publishedOn=$5, body=$6 WHERE author_id=$2`,
      [
